...
double g1 = 0.099274; //phd per S1 photon in liquid at dtCntr (not phe)
...
double FitEF ( double xPos_mm, double yPos_mm, double zPos_mm ) { // in V/cm
  ...
  return 212.716223709 - 5.0145653897*zPos_mm + 0.0514514976033*pow(zPos_mm, 2.0) - 0.000224872819366*pow(zPos_mm, 3.0) + 4.6123475598e-7*pow(zPos_mm, 4.0) - 3.42069868433e-10*pow(zPos_mm, 5.0);

}

 // Ionization and Secondary Scintillation (S2) parameters

double g1_gas = 0.08473; //phd per S2 photon in gas, used to get SE size
double s2Fano = 1.15; //Fano-like fudge factor for SE width
...
double E_gas = 7.768; //field in kV/cm between liquid/gas border and anode
