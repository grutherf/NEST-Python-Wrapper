...
double FitEF ( double xPos_mm, double yPos_mm, double zPos_mm ) { // in V/cm
  ...
  return 147.431375761 - 3.03129014586*zPos_mm + 0.0343192819835*pow(zPos_mm, 2.0) - 0.000156379508552*pow(zPos_mm, 3.0) + 3.31145682998e-7*pow(zPos_mm, 4.0) - 2.50628583785e-10*pow(zPos_mm, 5.0);

}

 // Ionization and Secondary Scintillation (S2) parameters

double g1_gas = 0.08708; //phd per S2 photon in gas, used to get SE size
double s2Fano = 0.2; //Fano-like fudge factor for SE width
...
double E_gas = 7.73; //field in kV/cm between liquid/gas border and anode
double eLife_us = 947.; //the drift electron mean lifetime in micro-seconds
