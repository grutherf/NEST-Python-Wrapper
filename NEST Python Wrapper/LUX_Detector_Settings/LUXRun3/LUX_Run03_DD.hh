...
double g1 = 0.115; //phd per S1 phot at dtCntr (not phe). Divide out 2-PE effect
...
double g1_gas = 0.0935; //phd per S2 photon in gas, used to get SE size
...
double E_gas = 6.11; //field in kV/cm between liquid/gas border and anode
double eLife_us = 650.; //the drift electron mean lifetime in micro-seconds
...
double dt_min = 80.; //minimum. Top of detector fiducial volume
double dt_max = 130.; //maximum. Bottom of detector fiducial volume
